jQuery(document).ready(function ($) {
            var options = {
                ...
                $ParkingPosition: 100,                              //[Optional] The offset position to park slide (this options applys only when slideshow disabled), default value is 0.
            ...
            function ScaleSlider() {
                ...
                if (bodyWidth)
                    jssor_slider1.$SetScaleWidth(Math.min(bodyWidth, 950));
                else
