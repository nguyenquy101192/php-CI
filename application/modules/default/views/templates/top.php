...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="header">
            <div id="header-left">
                <a href='<?php echo base_url();?>default/home'><img src="<?php echo base_url();?>public/images/icon/logo-header.png"/></a>
            </div>
            ...
            <div id="header-right">
                <div id='header-cart'>
                	<a href="<?php echo base_url();?>default/cart" id="tooltip-cart" title="This is your cart"><span class="fa fa-shopping-cart"></span>&nbsp;My cart: <?php if(isset($count)) echo $count; else echo "0";?>&nbsp;items - <?php if(isset($cost)) echo number_format($cost, "0", "", ","); else echo "0";?> $</a>
                </div>
            </div>
        </div>
        <!--End header-->