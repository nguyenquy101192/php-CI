...
<div id='pro-feedback'>
    ...
    <hr />
	<div id='feedback'>
		<div id="feed-message"><?php if(isset($msg)){echo $msg;}?></div>
        <span id="show_feed" onclick="clickFunc()">Leave a comment <font size="3" color="blue"><u>click here</u></font></span>
        <div class="notice">
        <!--comment-->
        <div id="feed-info">
            <div>
                <form action="<?php echo base_url();?>default/home/detail/<?php echo $proInfo[0]['pro_id'];?>" method="POST">
                    <label>Name</label>
        ...
        <div id="feed-list">
            ...
            <?php foreach ($listComment as $key=>$value){?>
				<div id="feed-item">
					<div><div class='rateit' data-rateit-value='<?php echo $value['feed_rate']?>' data-rateit-ispreset='true' data-rateit-readonly='true'></div>
					&nbsp<span id="feed-tile-comment"><?php echo $value['feed_title'];?> 
					</span></div>
					<div id="feed-inside"><?php echo $value['feed_content'];?></div>
					
					<div id="feed-inside" style="color: rgba(111, 111, 43, 1)">Date: <?php echo $value['feed_time'];?></div>
				</div>
				<br />
            <?php }?>
            </div>
