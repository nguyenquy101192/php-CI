    ...
    <div id="check-out">
    	...
    	<div id='check-out-info'>
    		...
    		<div class='check-out-content' id="info">
    			...
    			<li class="fields">
                    <input type="text" name="name" id="left" class="txtbox" value="<?php echo set_value('name'); ?>">
                    <span class="error"><i><?php echo form_error("name");?></i></span>    
                </li>    			
    			<li class="fields"><label id="right">Email</label></li>
    			<li class="fields">
                    <input type="text" name="email" id="left" class="txtbox" value="<?php echo set_value('email'); ?>">
                    <span class="error"><i><?php echo form_error("email");?></i></span>
                </li>
    			<li class="fields"><label>Address</label></li>
    			<li class="fields">
                    <input type="text" name="address" class="txtbox" value="<?php echo set_value('address'); ?>">
                    <span class="error"><i><?php echo form_error("address");?></i></span>
    			</li>
    			<li class="fields"><label>Phone</label></li>
    			<li class="fields">
                    <input type="text" name="phone" id="left" class="txtbox" value="<?php echo set_value('phone'); ?>">
    	...
    	<div id='check-out-method'>
    		...
    		<div class='check-out-content' id="method">
    			...
    			<li class="fields">
    				<input type="radio" name="shipping" checked="checked"><label>Fast(75$ - receive in 5 hours)</label>
    			</li>    			
    			<li class="fields">
    				<input type="button" name="next"
