...
<div class="info-button">
    ...
    <div class="button">
        <a href="<?php echo base_url(); ?>admin/brands/insert">
            <button class="insert fa fa-plus">&nbsp;Add brand</button>
        </a>
    </div>
</div>
...
<div class="table-center">
    <table class="result-table" border='1'>
        <tr class="title-table">
            <td>No</td>
            <td>Brand name&nbsp;<a href="<?php echo $current_url . $page_number . '/brand_name/' . $next_order; ?>"
