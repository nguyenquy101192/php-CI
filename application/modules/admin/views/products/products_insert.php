...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <span
        class="error"><?php if (isset($error_thumb_img)) foreach ($error_thumb_img as $value) echo $value . "<br>"; ?></span>
    <br/>
    <br/>
    <br/>
    ...
    <div>
        ...
        <input type="submit" name="insert" value="Insert" class="insert-cancel"/><input type="submit" name="cancel"
                                                                                        value="Cancel"
                                                                                        class="insert-cancel"/>
    </div>
</form>
