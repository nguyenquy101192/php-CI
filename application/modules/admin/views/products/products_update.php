...
<div id="update-cancel"><input type="submit" name="update" value="Update" class="update-cancel" />&nbsp;<input type="submit" name="cancel" value="Cancel" class="update-cancel" /></div>
</form>