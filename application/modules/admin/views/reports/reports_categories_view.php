...
<form action="<?php echo base_url() ?>admin/reports/report_category" method="POST">
    ...
    <select id="option">
        ...
        <option onclick="location.href='<?php echo base_url(); ?>admin/reports/category'" selected="selected">Category
        </option>
    </select>
    <br/>

    <div id="date-time">
        From: <input type="text" class="datepicker" name="from_date" value="<?php if (isset($from_date)) {
            echo $from_date;
        } else {
            echo date("Y/m/d");
        } ?>"> To: <input
            type="text" class="datepicker" name="to_date" value="<?php if (isset($to_date)) {
            echo $to_date;
        } else {
            echo date("Y/m/d");
        } ?>">
