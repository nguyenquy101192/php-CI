...
<div class="button">
    <a href="<?php echo base_url();?>admin/categories/insert"><button class="insert fa fa-plus">&nbsp;Add category</button></a>
    <a href="<?php echo base_url();?>admin/categories/move"><button class="insert">Move</button></a>
</div>
