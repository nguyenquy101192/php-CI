...
<div class="info-button">
    ...
    <div class="button">
        <a href="<?php echo base_url(); ?>admin/users/insert">
            <button class="insert fa fa-plus">&nbsp;Add user</button>
        </a>
    </div>
</div>
...
<div class="table-center">
    <table class="result-table" border='1'>
        <tr class="title-table">
            <td>No</td>
            <td>Username&nbsp;<a href="<?php echo $current_url . $page_number . '/user_name/' . $next_order; ?>"
                                 class="fa fa-sort"></a></td>
            <td>Email&nbsp;<a href="<?php echo $current_url . $page_number . '/user_email/' . $next_order; ?>"
                              class="fa fa-sort"></a></td>
            <td>Address&nbsp;<a href="<?php echo $current_url . $page_number . '/user_address/' . $next_order; ?>"
                                class="fa fa-sort"></a></td>
            <td>Phone</td>
            <td>Gender&nbsp;<a href="<?php echo $current_url . $page_number . '/user_gender/' . $next_order; ?>"
                               class="fa fa-sort"></a></td>
            <td>Level&nbsp;<a href="<?php echo $current_url . $page_number . '/user_level/' . $next_order; ?>"
                              class="fa fa-sort"></a></td>
