...
<div class="info-button">
    <div class="count-record">
        Per page: <?php if(isset($listOrders)){ echo "<b>". count($listOrders) . "</b>";}?> | 
        Total records: <?php
                            if(isset($total)){
                                echo "<b>" . $total . "</b>";
                            }
...
<table border='1' class="result-table">
    <tr class="title-table">
        <td>No</td>
        <td>Name&nbsp;<a href="<?php echo $current_url . $page_number . '/order_name/' . $next_order; ?>" class="fa fa-sort"></a></td>
        <td>Date Buy</td>
        <td>Status&nbsp;<a href="<?php echo $current_url . $page_number . '/order_status/' . $next_order; ?>" class="fa fa-sort"></a></td>
